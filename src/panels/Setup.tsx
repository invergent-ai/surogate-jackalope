    ...
    <div className="setup">
      <div className="term">
        <div className="term-bar">
          ...
          <span className="term-where">jackalope · setup</span>
          <span className="term-live">
            <i className="term-dot" /> first run
          </span>
        </div>
        ...
        <div className="term-brand">
          ...
          <div className="term-wordmark">
            <span className="tw-name">Jackalope</span>
            <span className="tw-by">by Surogate · set up your training environment</span>
          </div>
        </div>

        <div className="term-body">
          {/* ── left: the wizard ── */}
          <div className="term-wizard">
                    ...
                    {target.install && (
                      <div>
                        <div className="dim" style={{ marginBottom: 4 }}>
                          Install the {target.label} client:
                        </div>
            ...
            {step === 2 && (
              <div className="step-body">
                ...
                <h3 className="ready-title">You're set up</h3>
                <p className="dim">
          ...
          {/* ── right: the live showcase ── */}
          <div className="term-show">
            <Showcase />
          </div>
        </div>
        ...
        <div className="term-foot">
          ...
          <span className="dim">star</span>
          <span className="term-link">github.com/invergent-ai/surogate</span>
        </div>
      </div>
    </div>
  );
